#pragma checksum "D:\itea\homework\webregistration\lasthomework\Pages\Registration.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "11042f5653ac3c916ec29818df3edf5d3582a987"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"11042f5653ac3c916ec29818df3edf5d3582a987", @"/Pages/Registration.cshtml")]
...
#line 5 "D:\itea\homework\webregistration\lasthomework\Pages\Registration.cshtml"
    ...
    if (HttpContext.Request.Method == "POST")
    {
        ...
        bool checklog = uc.AddUser(login, password, repassword, name, address, age, sex);
        string showlogin = checklog ? "SUCCESS REG" : "FAIL REG";
...
#line hidden
            ...
            WriteLiteral("</h2>\r\n");
            EndContext();
#line 19 "D:\itea\homework\webregistration\lasthomework\Pages\Registration.cshtml"
    }
...
#line hidden
            ...
            EndContext();
            BeginContext(879, 1521, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4472e11056c743a89ba989961a182333", async() => {
                BeginContext(909, 1484, true);
                WriteLiteral(@"
        <div>
        ...
        <div>
            ...
            <input type=""password"" class =""pass"" name=""password"" pattern=""(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"" 
                   title=""Должен содержать символы или буквы большого  и малого регистра, и иметь не менее 8 символов"" required>
        </div>
        <div>
